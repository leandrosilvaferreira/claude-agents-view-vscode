...
⚠️ The **GitHub username** field must be exactly `leandrosilvaferreira` — Open VSX matches
...
`https://github.com/leandrosilvaferreira/claude-agents-view-vscode/raw/HEAD/resources/screenshot.png`,
...
- **Also publish to the VS Code Marketplace** — needs a separate Azure DevOps publisher and
  ...
  - name: Publish to VS Code Marketplace
    ...
    run: npx @vscode/vsce publish --packagePath claude-agents-monitor-*.vsix
  ```
